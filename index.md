...
## 🗑️ 5. Data Deletion & Account Removal  

You can request deletion of your account and all associated personal data at any time.

### Submit a deletion request (recommended method)

To request deletion **without using the app**, please submit the request via this form:

https://docs.google.com/forms/d/e/1FAIpQLSe8RykJL7naaPcdknIdo5rwNpJsd-CjOBphgReru0SpbGJ2ZA/viewform

After you submit the form:

- We will verify your details  
- Your Frentis account and all associated data will be deleted  
- Processing time: **up to 30 days**

This is the fastest and most reliable way to request deletion.

---

### Alternative method: Delete via web page  

You may also visit:

https://gpttabrez.github.io/frentis-privacy-policy/delete-account

and follow the steps shown there to submit your request.

---

### What will be deleted  

Upon verification, we will delete:

- Your user account  
- Personal information  
- Saved delivery addresses  
- Purchase history  
- Any in-app data linked to your account  
...
You must submit a deletion request using the form above or the deletion page.
